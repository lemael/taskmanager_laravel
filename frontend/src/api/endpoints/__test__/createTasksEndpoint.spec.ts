...
import { JsonTaskType } from "../../../api/types";
...
describe("events", () => {
  ...
  const task1 = createTask(
    "2016-01-31T10:00:00+01:00",
    "2016-01-31T13:00:00+01:00",
    false
  );
  const task2 = createTask(
    "2015-11-29T10:00:00+01:00",
    "2015-11-29T13:00:00+01:00",
    false
  );
  const task3 = createTask(
    "2017-09-29T00:00:00.000+02:00",
    "2017-09-29T23:59:59.000+02:00",
    true
  ); // we get these from cms
  ...
  const taskModel1 = createTaskModel(
    "2016-01-31T10:00:00+01:00",
    "2016-01-31T13:00:00+01:00",
    false
  );
  const taskModel2 = createTaskModel(
    "2015-11-29T10:00:00+01:00",
    "2015-11-29T13:00:00+01:00",
    false
  );
  const taskModel3 = createTaskModel(
    "2017-09-29T00:00:00.000+02:00",
    "2017-09-29T23:59:59.000+02:00",
    true
  );
  const taskModel4 = createTaskModel(
    "2018-02-28T18:00:00.000-05:00",
    "2018-06-01T17:59:59.000-04:00",
    true
  );
  ...
  it("should map params to url", () => {
    expect(tasks.mapParamsToUrl(params)).toBe(
      `https://integreat-api-url.de/api/tasks?start=2016-01-31T10:00:00+01:00&end=2016-01-31T13:00:00+01:00&isFinish=false`
    );
  });
